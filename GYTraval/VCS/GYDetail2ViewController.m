...
@interface GYDetail2ViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    BOOL fold[4];
}
...
@implementation GYDetail2ViewController
...
- (void)registerCell{
    ...
    [self.tv registerNib:[UINib nibWithNibName:@"GYDetail3Cell" bundle:nil] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        GYDetail3Cell *cell=[tableView dequeueReusableCellWithIdentifier:@"cell"];
        cell.block=^(){
